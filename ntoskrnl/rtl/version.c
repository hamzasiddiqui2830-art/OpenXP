...
// undefined and MSVC diagnoses it as C4293. Those old-style masks cannot
// encode such conditions in a 64-bit value; return no condition rather than
// performing an invalid shift. Lower types retain the original layout.
//
static ULONG
